...
public class VehicleController {
    ...
    public EPager<Vehicle> getList(String groupId, String carNumber, @RequestParam(required = false, defaultValue = "1") Integer page, @RequestParam(required = false, defaultValue = "20") Integer rows) {
...
//			if (verifyCarTime(vehicle.getRecvtime(),vehicle.getGpstime(),vehicle.getVhcofflinemin())) {
